      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="container relative z-10 mx-auto px-4 md:px-6">
            ...
            >
              <span className="inline-block rounded-full bg-white/60 dark:bg-primary/15 px-4 py-1.5 text-xs font-bold text-primary backdrop-blur-sm border border-transparent dark:border-primary/20">
                {t("home.badge")}
              </span>
              <h1 className="mt-6 text-4xl font-black leading-tight text-foreground md:text-6xl">
                {t("home.heading1")}{" "}
                <span className="text-gradient-hero">{t("home.heading2")}</span>
              </h1>
